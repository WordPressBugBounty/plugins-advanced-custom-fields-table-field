...
if ( ! class_exists( '\ACFTablefield\Field' ) ) {
	...
	class Field extends \acf_field {
		...
		*/
		...
		function __construct() {
			...
			*/
			$this->settings = array(
				'version' => ACF_TABLE_FIELD_PLUGIN_VERSION,
			);
			...
			*/
			...
			$this->preview_image = FileSystem::get('plugin_dir_path') . '/assets/images/field-preview-table.png';
		...
		*/
		...
		function input_admin_enqueue_scripts() {
			...
			// register & include JS
			wp_enqueue_script( 'acf-input-table', FileSystem::get('plugin_dir_url') . 'js/init.js', array( 'jquery', 'acf-input' ), $this->settings['version'], true );
			wp_enqueue_script( 'acf-input-table-execute', FileSystem::get('plugin_dir_url') . 'js/execute.js', array( 'acf-input-table' ), $this->settings['version'], true );

			// register & include CSS
			wp_register_style( 'acf-input-table', FileSystem::get('plugin_dir_url') . 'css/input.css', array( 'acf-input' ), $this->settings['version'] );
